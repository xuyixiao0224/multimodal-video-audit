...
2. **Scan**: Interaction Loop (Student speaks/clicks -> System responds).
3. **Logic Check**:
   - "Check Over-Refusal..."
   - "Check Over-Acceptance (Completeness)..."
   - "Check System Functionality (Latency)..."
    ...
    "detected_errors": [
        {
            ...
            "student_input": "What the student said or did (e.g., 'Clicked Submit')",
            "system_feedback": "What the system said or did (e.g., 'No response')",
            "content": "Detailed description of the error...",
